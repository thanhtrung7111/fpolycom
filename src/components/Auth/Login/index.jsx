...
export default function Login() {
  ...
  const loginSchema = new Yup.object().shape({
    tenDangNhap: Yup.string().required("Không để trống tên đăng nhập!"),
    matKhau: Yup.string().required("Không để trống mật khẩu!"),
  });
  const rememberMe = () => {
    setValue(!checked);
  };
                      ...
                      <div className="signin-area mb-3.5">
                        <div className="flex justify-center">
                          <button
                            ...
                            type="submit"
                            className={`${
                              currentUser.isLoading && "disabled:opacity-70"
