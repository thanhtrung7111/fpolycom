...
export default function Dashboard() {
  ...
  return (
    <>
      <div className="welcome-msg w-full">
        <div>
          <p className="text-qblack text-lg">
            Chào, {currentUser?.data?.tenNguoiDung}
          </p>
      ...
      <div className="dashboard-info mt-8 flex flex-col gap-y-3 justify-between items-start bg-primarygray px-7 py-7">
        <div className="">
          <p className="title text-[22px] font-semibold">Thông tin cá nhân</p>
          <div className="mt-5">
            <table className="flex flex-col">
              <tr className="inline-flex mb-5">
                <td className="text-base text-qgraytwo w-[200px] block">
                  <div>Tên:</div>
                </td>
            ...
            <div className="mt-5">
              <table className="flex flex-col">
                <tr className="inline-flex mb-5">
                  ...
                  <td className="text-base text-qblack font-medium">
                    {currentUser.data.cuaHang.tenCuaHang}
                  </td>
                </tr>
                <tr className="inline-flex mb-5">
                  <td className="text-base text-qgraytwo w-[200px] block">
                ...
                <tr className="inline-flex mb-5">
                  ...
                  <td className="text-base text-qblack font-medium">
                    {currentUser.data.cuaHang.soDienThoai}
                  </td>
                </tr>
                <tr className="inline-flex mb-5">
                  <td className="text-base text-qgraytwo w-[200px] block">
                  ...
                  <td
                    className={`${
                      currentUser.data?.cuaHang?.trangThaiCH == "Đang hoạt động"
                ...
                <tr className="inline-flex mb-5">
                  ...
                  <td className="text-base text-qblack font-medium">
                    {currentUser.data.cuaHang.diaChi}
                  </td>
                </tr>
              </table>
            </div>
