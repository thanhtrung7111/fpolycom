        ...
        <div className="aboutus-wrapper w-full">
          <div className="container-x mx-auto">
            <div className="w-full min-h-[665px] lg:flex lg:space-x-12 items-center pb-10 lg:pb-0">
              <div className="md:w-[570px] w-full md:h-[560px] h-auto rounded my-5 lg:my-0 flex justify-center items-center">
                <img
                  src={`/assets/images/logoTeam.png`}
                  alt="about"
                  className="w-100"
                />
              </div>
              <div className="content flex-1">
                ...
                <ul className="text-[15px] text-qgraytwo leading-7 list-disc ml-5 mb-5">
                  <li>Nguyễn Viết Đức</li>
                  <li>Đỗ Thành Trung</li>
                  <li>Võ Nguyễn Thành Phát</li>
                  <li>Vòng Trung</li>
                  <li>Huỳnh Công Trường</li>
                  <li>Trương Thanh Quân</li>
                </ul>
                  ...
                  <div className="flex items-center space-x-2.5 mt-3">
                    ...
                    <div>
                      ...
                      <p className="text-qgraytwo text-[13px]">
                        <b>Cao đẳng FPT Polytechnic</b> - Giảng viên ngành Phát
                        Triển phần mềm
                      </p>
                    </div>
                  </div>
              ...
              <div className="flex space-x-5 items-center">
                ...
                <div>
                  <p className="text-black text-[15px] font-700 tracking-wide mb-1 uppercase">
                    FPT Polytechnic e-commerce
                  </p>
                  <p className="text-sm text-qblack">Phát triển cá nhân 2 - Java 6</p>
                </div>
              </div>
            </div>
            <div className="item">
